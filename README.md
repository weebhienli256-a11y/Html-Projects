# Responsive All About Me
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>All About Li</title>
    <style>
        main {
            display: grid;
...
<body>
    <p class="media-query-class"><strong>Wee-Bhien L. Li, BSIT - 601:</strong></p>
    <main>
        <section>
        <h3>Responsive All About Me:</h3>
        <p>
    ...
    <section>
        ...
        <div class="img-container">
            <img src="Hobbies.jpg" alt="Hobs">
        </div>
    </section>
    </main>
<body>
    <p class="media-query-class"><strong>All Accomplishments!</strong></p>
    <main>
        <section>
          <h3> About my Goals in Life!</h3> 
          <p>
            ...
            <tr>
                <th>
                    <div class="img-container1">
                        <img src="Goals1.jpg" alt="Goals1">
                    </div>
                </th>
                <th>
                    <div class="img-container1">
                        <img src="Goals2.jpg" alt="Goals2">
                    </div>
                </th>
            </tr>
          </table>
        ...
        <section>
            <h3>I want to start a real experience</h3>
            <p>
        ...
        <section>
            <h3> Nothing is impossible unless you make it!</h3>
            <p>
               ...
               try to learn something new, that feels weird for you. That's what who I want to become.
                ...
                This video tag was about a cat, but your browser doesn't support it.
            </video>
        </section>
    </main>
</body>
